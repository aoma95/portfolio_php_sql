...
if (isset($_POST) and !empty($_POST)) {
  if (!empty(htmlspecialchars($_POST['username'])) and !empty(htmlspecialchars($_POST['password']))) {
    ...
    if ($admin) {
      ...
      header('location:/php_portfolio/admin/view/dashboard_view.php');
    } else {
...
<body class="text-center">
  <form class="form-signin" action="" method="POST">
    ...
    <input type="text" name="username" id="inputName" class="form-control" placeholder="Nom" required="" autofocus="" value="
